...
In order to build this project manually (as we elected to do on Image 9, above), we need to run the `npm install` task - by clicking on the NPM tile (Monterey main view - Image 11). Click on 
